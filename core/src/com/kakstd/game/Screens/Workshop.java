...
public class Workshop implements Screen {
    ...
    private int i = 0;
    /*private boolean purchased1 = true, purchased2 = false, purchased3 = false, purchased4 = false, purchased5 = false, purchased6 = false, purchased7 = false, purchased8 = false;
    private boolean purchased_submarine1 = true, purchased_submarine2 = false, purchased_submarine3 = false, purchased_submarine4 = false, purchased_submarine5 = false, purchased_submarine6 = false, purchased_submarine7 = false, purchased_submarine8 = false, purchased_submarine9 = false, purchased_submarine10 = false;
    public static int Gold = 0;
    public static int Scrap = 0;
    private static float s1_hp_updated = 1, s1_spd_updated = 1, s1_cd_updated = 0;
    private static float s2_hp_updated = 1, s2_spd_updated = 1, s2_cd_updated = 0;
    private static float s3_hp_updated = 1, s3_spd_updated = 1, s3_cd_updated = 0;
    private static float s4_hp_updated = 1, s4_spd_updated = 1, s4_cd_updated = 0;
    private static float s5_hp_updated = 1, s5_spd_updated = 1, s5_cd_updated = 0;
    private static float s6_hp_updated = 1, s6_spd_updated = 1, s6_cd_updated = 0;
    private static float s7_hp_updated = 1, s7_spd_updated = 1, s7_cd_updated = 0;
    private static float s8_hp_updated = 1, s8_spd_updated = 1, s8_cd_updated = 0;
    private static float s9_hp_updated = 1, s9_spd_updated = 1, s9_cd_updated = 0;
    private static float s10_hp_updated = 1, s10_spd_updated = 1, s10_cd_updated = 0;
    public static float[][] upgrade_massive = {
            {s1_hp_updated, s1_spd_updated, s1_cd_updated},
            {s2_hp_updated, s2_spd_updated, s2_cd_updated},
            {s3_hp_updated, s3_spd_updated, s3_cd_updated},
            {s4_hp_updated, s4_spd_updated, s4_cd_updated},
            {s5_hp_updated, s5_spd_updated, s5_cd_updated},
            {s6_hp_updated, s6_spd_updated, s6_cd_updated},
            {s7_hp_updated, s7_spd_updated, s7_cd_updated},
            {s8_hp_updated, s8_spd_updated, s8_cd_updated},
            {s9_hp_updated, s9_spd_updated, s9_cd_updated},
            {s10_hp_updated, s10_spd_updated, s10_cd_updated}
    };*/
    ...
    /*private int price_hp_1 = 500, price_speed_1 = 750, price_cooldown_1 = 1000;
    private int price_hp_2 = 500, price_speed_2 = 750, price_cooldown_2 = 1000;
    private int price_hp_3 = 500, price_speed_3 = 750, price_cooldown_3 = 1000;
    private int price_hp_4 = 500, price_speed_4 = 750, price_cooldown_4 = 1000;
    private int price_hp_5 = 500, price_speed_5 = 750, price_cooldown_5 = 1000;
    private int price_hp_6 = 500, price_speed_6 = 750, price_cooldown_6 = 1000;
    private int price_hp_7 = 500, price_speed_7 = 750, price_cooldown_7 = 1000;
    private int price_hp_8 = 500, price_speed_8 = 750, price_cooldown_8 = 1000;
    private int price_hp_9 = 500, price_speed_9 = 750, price_cooldown_9 = 1000;
    private int price_hp_10 = 500, price_speed_10 = 750, price_cooldown_10 = 1000;
    protected int prices[][] = {
            {price_hp_1, price_speed_1, price_cooldown_1},
            {price_hp_2, price_speed_2, price_cooldown_2},
            {price_hp_3, price_speed_3, price_cooldown_3},
            {price_hp_4, price_speed_4, price_cooldown_4},
            {price_hp_5, price_speed_5, price_cooldown_5},
            {price_hp_6, price_speed_6, price_cooldown_6},
            {price_hp_7, price_speed_7, price_cooldown_7},
            {price_hp_8, price_speed_8, price_cooldown_8},
            {price_hp_9, price_speed_9, price_cooldown_9},
            {price_hp_10, price_speed_10, price_cooldown_10},
    };
    protected boolean purchased_torpedos[] = {purchased1, purchased2, purchased3, purchased4, purchased5, purchased6, purchased7, purchased8};
    protected boolean purchased_submarines[] = {purchased_submarine1, purchased_submarine2, purchased_submarine3, purchased_submarine4, purchased_submarine5, purchased_submarine6, purchased_submarine7, purchased_submarine8, purchased_submarine9, purchased_submarine10};
*/
    ...
    /*public static class DataDescriptor{
        private static boolean purchased1 = true, purchased2 = false, purchased3 = false, purchased4 = false, purchased5 = false, purchased6 = false, purchased7 = false, purchased8 = false;
        private static boolean purchased_submarine1 = true, purchased_submarine2 = false, purchased_submarine3 = false, purchased_submarine4 = false, purchased_submarine5 = false, purchased_submarine6 = false, purchased_submarine7 = false, purchased_submarine8 = false, purchased_submarine9 = false, purchased_submarine10 = false;
        public static int Gold = 0;
        public static int Scrap = 0;
        private static float s1_hp_updated = 1, s1_spd_updated = 1, s1_cd_updated = 0;
        private static float s2_hp_updated = 1, s2_spd_updated = 1, s2_cd_updated = 0;
        ...
        private static int price_hp_1 = 500, price_speed_1 = 750, price_cooldown_1 = 1000;
        private static int price_hp_2 = 500, price_speed_2 = 750, price_cooldown_2 = 1000;
        private static int price_hp_3 = 500, price_speed_3 = 750, price_cooldown_3 = 1000;
        private static int price_hp_4 = 500, price_speed_4 = 750, price_cooldown_4 = 1000;
        private static int price_hp_5 = 500, price_speed_5 = 750, price_cooldown_5 = 1000;
        private static int price_hp_6 = 500, price_speed_6 = 750, price_cooldown_6 = 1000;
        private static int price_hp_7 = 500, price_speed_7 = 750, price_cooldown_7 = 1000;
        private static int price_hp_8 = 500, price_speed_8 = 750, price_cooldown_8 = 1000;
        private static int price_hp_9 = 500, price_speed_9 = 750, price_cooldown_9 = 1000;
        private static int price_hp_10 = 500, price_speed_10 = 750, price_cooldown_10 = 1000;
